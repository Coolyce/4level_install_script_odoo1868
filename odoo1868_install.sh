...
sudo adduser --system --quiet --shell=/bin/bash --home=$OE_HOME --gecos 'ODOO1868' --group $OE_USER
...
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/ShaheenHossain/neudibel_4levels_odoo_18ent $OE_HOME_EXT/
